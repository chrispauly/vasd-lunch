# 🎙️ V A S D Lunch – Alexa Custom Skill Setup Guide

This guide walks you through setting up the **"V A S D Lunch"** Alexa Custom Skill using the Amazon Developer Console so you can talk to Alexa on any Echo device or the Alexa app.

---

## 📋 Features

- **Invocation Name:** `v a s d lunch` (spelled out with spaces so Alexa recognizes the initialism *V-A-S-D*).
- **Conversational Launch:**
  - *"Alexa, open V A S D Lunch"*
  - Alexa asks: *"Welcome to V A S D Lunch! Would you like the lunch menu for elementary, middle, or high school?"*
  - You answer: *"Elementary"* (or *"Middle school for tomorrow"*, etc.)
- **One-Shot Direct Invocations:**
  - *"Alexa, ask V A S D Lunch what's for lunch today for elementary school"*
  - *"Alexa, ask V A S D Lunch what's for lunch tomorrow for middle school"*
  - *"Alexa, ask V A S D Lunch what's for lunch next week for high school"*
  - *"Alexa, ask V A S D Lunch what was for lunch yesterday for elementary school"*
...
- **Endpoint URL:** `https://<your-project>.vercel.app/api/alexa`
- *(During local testing, you can use ngrok or similar tunneling tool if desired: `https://<id>.ngrok-free.app/api/alexa`)*

---

### Step 2: Create the Skill in Amazon Developer Console
...
4. Configure basic skill settings:
   - **Skill name:** `V A S D Lunch`
   - **Primary locale:** `English (US)`
   - **Experience / Model:** `Custom`
   - **Hosting service:** `Provision your own` (since it is hosted on Vercel)
5. Click **Next** at the top right, review, and click **Create Skill**.
...
3. Copy its entire JSON contents and paste it into the JSON Editor in the Alexa Developer Console, replacing any template content.
...
4. In the SSL certificate dropdown below it, choose:
   ...
   *(All `*.vercel.app` domains use standard trusted wildcard SSL certificates).*
...
3. You can now test by typing in the Alexa Simulator or speaking into your microphone:

#### Test Scenarios:

**Scenario A: Interactive Invocation**
> **You:** `open v a s d lunch`
>
> **Alexa:** `Welcome to V A S D Lunch! Would you like the lunch menu for elementary, middle, or high school?`
>
> **You:** `elementary`
>
...
> **You:** `ask v a s d lunch what's for lunch tomorrow for middle school`
>
> **Alexa:** `Tomorrow for Middle School (6-8) lunch, ...`

**Scenario C: Next Week's High School Lunch**
> **You:** `ask v a s d lunch what's for lunch next week for high school`
>
...
> **You:** `ask v a s d lunch what was for lunch yesterday for elementary school`
>
...
- Just say: **"Alexa, open V A S D Lunch"** to your Echo speaker!
